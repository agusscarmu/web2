...
<div class="conteo">
    <h1 class="revealUp">Actualmente hay {$count} pacientes esperando a ser atendidos</h1>
</div>
<div>
    <h1 class="revealUp2"> Lista de pacientes: </h1>
</div>
<div class="revealUp3 tablaspacientes shadow-lg p-3 mb-5 bg-body rounded">
<table class="table">
